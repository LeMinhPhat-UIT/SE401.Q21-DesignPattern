...
#table(
  ...
  [Mục đích chính],
  [Đơn giản hóa cách sử dụng một subsystem phức tạp.],
  [Làm hai interface không tương thích có thể làm việc với nhau.],

  [Vấn đề giải quyết],
  [Client phải gọi quá nhiều class hoặc quá nhiều bước.],
  [Client không dùng được class có sẵn vì interface không khớp.],

  [Số lượng class thường bọc],
  [Thường bọc nhiều class/subsystem.],
  [Thường bọc một class hoặc một service không tương thích.],
...
#table(
  ...
  [Ví dụ],
  [`CheckoutFacade` gọi Payment, Inventory, Email.],
